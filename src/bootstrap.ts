...
export async function multiStepInput(context: ExtensionContext) {
	...
	const shellTask = new vscode.Task(
        ...
        'Shell Command: ls -la',
        'shell',
        new vscode.ShellExecution('ls -la /workspaces/test_ws')
    );

    // Optionally, execute or run the shell task here (e.g., using TaskExecution)
    vscode.tasks.executeTask(shellTask);  // This will execute the shell task immediately
